    ...
    for prop in [0.1]:
        for cov_qual in ["good", "bad"]:
            ...
            for objective in ["l1", "l2", "entropy"]:
                ...
                for i in range(N):
                    print(i)                   
                    filename = datdir + 'RHC_approxBal_'+cov_qual+'_'+str(i)+'.csv'
                    data = pd.read_csv(filename)

                    cov, T, Y, Y0, Y1 = data.iloc[:,:-4].as_matrix().copy(), \
                        data["simT"].copy(), data["simY"].copy(), \
                        data["ctrlPred"].copy(), data["trtPred"].copy()
                ...
                np.savetxt("RHC_att_sqerr_"+objective+"_"+cov_qual+"_"+str(int(prop*100))+".csv", att_sqerrs, delimiter=",")
                np.savetxt("RHC_att_covbal_l1_"+objective+"_"+cov_qual+"_"+str(int(prop*100))+".csv", att_covbal_l1s, delimiter=",")
                np.savetxt("RHC_att_covbal_l2_"+objective+"_"+cov_qual+"_"+str(int(prop*100))+".csv", att_covbal_l2s, delimiter=",")
                np.savetxt("RHC_att_covbal_linf_"+objective+"_"+cov_qual+"_"+str(int(prop*100))+".csv", att_covbal_linfs, delimiter=",")


                np.savetxt("RHC_ate_sqerr_"+objective+"_"+cov_qual+"_"+str(int(prop*100))+".csv", ate_sqerrs, delimiter=",")
                np.savetxt("RHC_ate_covbal_l1_"+objective+"_"+cov_qual+"_"+str(int(prop*100))+".csv", ate_covbal_l1s, delimiter=",")
                np.savetxt("RHC_ate_covbal_l2_"+objective+"_"+cov_qual+"_"+str(int(prop*100))+".csv", ate_covbal_l2s, delimiter=",")
                np.savetxt("RHC_ate_covbal_linf_"+objective+"_"+cov_qual+"_"+str(int(prop*100))+".csv", ate_covbal_linfs, delimiter=",")
            ...
            att_err_vs_covbal.to_csv("RHC_att_err_vs_covbal_"+cov_qual+".csv")
            ate_err_vs_covbal.to_csv("RHC_ate_err_vs_covbal_"+cov_qual+".csv")
            ...
            plt.tight_layout()
            fig1.savefig("RHC_ate_err_vs_covbal_"+cov_qual+".pdf")
            ...
            plt.tight_layout()
            fig2.savefig("RHC_att_err_vs_covbal_"+cov_qual+".pdf")
